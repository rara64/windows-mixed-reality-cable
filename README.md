...
I created the plug extender and the corresponding PCB with USB and HDMI ports. Both seem to be functional, but don't fully work with the headset - there is a weird pattern on the headset display.
